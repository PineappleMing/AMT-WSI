...
# model1.load_state_dict(torch.load(HP.models_path + 'luad1.pth'))
# model2.load_state_dict(torch.load(HP.models_path + 'luad2.pth'))
# model3.load_state_dict(torch.load(HP.models_path + 'luad3.pth'))
# attn_clsfr1.load_state_dict(torch.load(HP.models_path + 'luad_atten1.pth'))
# attn_clsfr2.load_state_dict(torch.load(HP.models_path + 'luad_atten2.pth'))
...
writer = SummaryWriter(log_dir=HP.log_dir + 'brca/')
