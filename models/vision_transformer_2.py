...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, image_size=256, patch_size=16, in_c=3, embed_dim=768, norm_layer=None):
        """
...
class VisionTransformer(nn.Module):
    def __init__(self, image_size=256, patch_size=16, in_c=3, num_classes=1000,
